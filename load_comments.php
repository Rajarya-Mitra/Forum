...
foreach ($result as $row) {
    ...
    $sql2 = "SELECT u_name,u_role,u_profile_photo FROM forum.users WHERE u_id = $comment_u_id";
    $row2 = selectsql($sql2);
    ...
    echo '<div>
        <button title="Like" class="btn btn-sm btn-info like-btn" data-id="' . $comment_id . '">
