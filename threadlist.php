<!doctype html>
<html lang='en'>
<?php require_once '/partials/dbconnect.php'; ?>
<head>
    <meta charset="utf-8">
    ...
    <?php
        ...
        if (isset($_SESSION['loggedin']) && $_SESSION['loggedin'] == true) {
            ...
            foreach ($result as $row) {
                ...
                echo '<div class="media my-3">
                        ...
                        <div>
                            <button title="Like" class="btn btn-sm btn-info like-btn" data-type="thread" data-id="' . $t_id . '">
        ...
        <div class="container" id="">
            ...
            foreach ($result as $row) {
                ...
                $sql2 = "SELECT u_name, u_role,u_profile_photo FROM forum.users WHERE u_id = '$t_u_id'";
                $row2 = selectsql($sql2);
                $liked = false;
                $user_photo = !empty($row2[0]['u_profile_photo']) ? $row2[0]['u_profile_photo'] : 'img/user_default.png';
                if (isset($_SESSION['loggedin']) && $_SESSION['loggedin'] == true) {
